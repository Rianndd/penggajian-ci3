        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <div class="card">
              ...
              <a href="<?php echo base_url('admin/dataJabatan/tambahData') ?>" class="btn btn-success col-4 mb-2" style="margin-left: 20px;">Tambah Data</a>
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    foreach ($jabatan as $j) : ?>
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-icon btn-primary" href="<?php echo base_url('admin/dataJabatan/updateData/' . $j->id_jabatan) ?>"><i class="bx bx-edit-alt me-1"></i></a>
                          <a onclick="return confirm('Yakin Hapus ?')" class="btn btn-icon btn-danger" href="<?php echo base_url('admin/dataJabatan/deleteData/' . $j->id_jabatan) ?>"><i class="bx bx-trash me-1"></i></a>
                        </td>
                      <?php endforeach; ?>
                      </tr>
                  </tbody>

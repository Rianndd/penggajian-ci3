            ...
            <div class="col-xxl">
              <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                  <h5 class="mb-0">Tambah Potongan Gaji</h5>
                </div>
                <div class="card-body">
                  <form action="<?php echo base_url('admin/potonganGaji/tambahDataAksi') ?>" method="POST">
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="potongan" class="form-control" id="basic-default-name" placeholder="Masukkan Jenis Potongan Gaji">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input type="number" name="jml_potongan" class="form-control" id="basic-default-name" placeholder="Masukkan Jumlah Potongan">

            ...
            <div class="card mx-auto" style="width: 35%;">
              ...
              <form action="<?php echo base_url('admin/slipGaji/cetakSlipGaji') ?>" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label for="inputPassword" class="col-sm-3 col-form-label mb-3">Nama Pegawai</label>
                    <div class="col-sm-9 mb-3">
                  ...
                  <div>
                    <button style="width: 100%;" type="submit" class="btn btn-primary">Cetak Slip Gaji</button>
                  </div>
                </div>
              </form>
            </div>

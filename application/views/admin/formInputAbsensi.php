        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-md-6 col-lg-12 mb-3">
              <div class="card">
                <div class="card-header bg-primary text-white mb-3">Form Input Absensi</div>
                <div class="card-body">
                  <form class="row g-3">
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                      <button type="submit" class="btn btn-primary m-lg-4">Generate</button>
                    </div>
                  </form>
                </div>
              </div>
              ...
              <div class="alert alert-info text-black mt-3">
                Menginputkan Data Kehadiran Pegawai Bulan : <span class="font-weight-bold"><?php echo $bulan ?></span> Tahun : <span class="font-weight-bold"><?php echo $tahun ?></span>
              </div>
              <div class="card">
                <div class="card-body">
                      ...
                      <table class="table table-hover">
                        <thead>
                          <tr>
                            ...
                            <th width="11%">Sakit</th>
                            <th width="11%">Alpha</th>
                          </tr>
                        </thead>
                        <tbody class="table-border-bottom-0">
                          ...
                          foreach ($input_absensi as $a) : ?>
                            <tr>
                              ...
                              <input type="hidden" name="jabatan[]" value="<?php echo $a->jabatan ?>" class="form-control">
                              <td><?php echo $no++ ?></td>

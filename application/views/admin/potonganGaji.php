      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <div class="card">
              <h5 class="card-header">Setting Potongan Gaji</h5>
              <a href="<?php echo base_url('admin/potonganGaji/tambahData') ?>" class="btn btn-success col-4 mb-2" style="margin-left: 20px;">Tambah Data</a>
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    foreach ($pot_gaji as $p) : ?>
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-icon btn-primary" href="<?php echo base_url('admin/potonganGaji/updateData/' . $p->id) ?>"><i class="bx bx-edit-alt me-1"></i></a>
                          <a onclick="return confirm('Yakin Hapus ?')" class="btn btn-icon btn-danger" href="<?php echo base_url('admin/potonganGaji/deleteData/' . $p->id) ?>"><i class="bx bx-trash me-1"></i></a>
                        </td>
                      <?php endforeach; ?>
                      </tr>
                  </tbody>

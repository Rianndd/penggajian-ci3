                    ...
                    <div class="card-body">
                      <form action="<?php echo base_url('admin/dataJabatan/tambahDataAksi') ?>" method="POST" >
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="nama_jabatan" class="form-control" id="basic-default-name" placeholder="Masukkan Jabatan">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="number" name="gaji_pokok" class="form-control" id="basic-default-name" placeholder="Masukkan Gaji Pokok">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="number" name="tj_transport" class="form-control" id="basic-default-name" placeholder="Masukkan Tunjangan Transport">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="number" name="uang_makan" class="form-control" id="basic-default-name" placeholder="Masukkan Uang Makan">

            ...
            <div class="col-xxl">
              <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                  <h5 class="mb-0">Update Data Pegawai</h5>
                </div>
                <div class="card-body">
                  ...
                  <form action="<?php echo base_url('admin/dataPegawai/updateDataAksi') ?>" method="POST" enctype="multipart/form-data">
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input type="hidden" name="id_pegawai" value="<?php echo $p->id_pegawai ?>" class="form-control" id="basic-default-name" placeholder="Masukkan NIK">
                        <input type="number" name="nik" value="<?php echo $p->nik ?>" class="form-control" id="basic-default-name" placeholder="Masukkan NIK">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="nama_pegawai" value="<?php echo $p->nama_pegawai ?>" class="form-control" id="basic-default-name" placeholder="Masukkan Nama Pegawai">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="username" value="<?php echo $p->username ?>" class="form-control" id="basic-default-name">
                        <?php echo form_error('username', '<div class="text-small text-danger"></div>') ?>
                      </div>
                    </div>
                    <div class="row mb-3">
                      <div class="col-sm-10">
                        <input type="hidden" name="password"  class="form-control" id="basic-default-name" placeholder="">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input type="date" value="<?php echo $p->tanggal_masuk ?>" name="tanggal_masuk" class="form-control" id="basic-default-name" placeholder="">

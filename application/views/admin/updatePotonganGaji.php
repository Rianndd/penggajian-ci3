            ...
            <div class="col-xxl">
              <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                  <h5 class="mb-0">Update Potongan Gaji</h5>
                </div>
                <div class="card-body">
                  <?php foreach ($pot_gaji as $p) : ?>
                  <form action="<?php echo base_url('admin/potonganGaji/updateDataAksi') ?>" method="POST">
                    <div class="row mb-3">
                      <label class="col-sm-2 col-form-label" for="basic-default-name">Jenis Potongan</label>
                      <div class="col-sm-10">
                        <input type="hidden" name="id" class="form-control" id="basic-default-name" value="<?php echo $p->id ?>" placeholder="Masukkan Jabatan">
                        <input type="text" name="potongan" value="<?php echo $p->potongan ?>" class="form-control" id="basic-default-name" placeholder="Masukkan Jenis Potongan Gaji">
                        <?php echo form_error('potongan', '<div class="text-small text-danger"></div>') ?>
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label class="col-sm-2 col-form-label" for="basic-default-name">Jumlah Potongan</label>
                      <div class="col-sm-10">
                        <input type="number" name="jml_potongan" value="<?php echo $p->jml_potongan ?>" class="form-control" id="basic-default-name" placeholder="Masukkan Jumlah Potongan">
